    ...
    >
      <div className='flex flex-col md:flex-row w-10/12 mx-auto gap-14 my-20 items-center'>
        <div className='md:w-1/2'>
         <img src={process.env.PUBLIC_URL+'/images/footer_text.png'} alt=""  className='w-full'/>
        </div>
        <div className='md:w-1/2'>
          ...
          <div className='w-4/5 md:w-full mx-auto'>
            <form onSubmit={handleSubmit(onSubmit)} className="w-full mx-auto my-5  rel" data-aos="fade-up" data-aos-duration="1500" >
              ...
              <div className='flex w-3/4 mx-auto gap-10 my-3 md:my-12'>
                <button className='bg-[#de641d] px-2 py-2  font-bold w-full  rounded-full  text-md tracking-wide text-[#fff]' type='submit'>送出</button>
